...
<html lang="en">
 ...
 <?php		
$conn=new mysqli('localhost','root','','helloworld');
#mysql_select_db('details');
if(isset($_POST['s1']))
{ 
$Sname = $_POST['sname'];
$RESULT = $conn->query("SELECT count(*) FROM basicdetails WHERE  `Approve`='1' AND (`FirstName` LIKE '%$Sname%' or `LastName` LIKE '%$Sname%')");
...
?>
 ...
 <footer class="text-right">
            ...
            |   <a href="http://znumerique.azurewebsites.net" target="_parent"></a></p>
          </footer>         
        </div>
      </div>
    </div>    
