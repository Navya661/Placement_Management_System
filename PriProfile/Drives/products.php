...
<html>
	<head>
		...
		<title>SJEC | Campus Drives</title>
		<meta name="viewport"
					...
					<div class="top-nav">
						...
						<ul class="nav1">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">SJEC<i>Goto Placement Homepage</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
		...
		<div class="products-top">
			...
			<div class="container">
				...
				<h5 class="wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<span>The companies which looked after us for several years</span>
				</h5>
				<div class="products-top-grids wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Google</h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://about.google/" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				...
				<div class="products-top-grids wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Microsoft</h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://www.microsoft.com/en-in/about/" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Directi </h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href=https://www.directi.com/" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Intel</h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://www.intel.in/content/www/in/en/homepage.html" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Visvesvaraya Institute of Technology</h6>
					<h4>
						<a href="../pdrive.php" style="color: white">Placement Management System</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
