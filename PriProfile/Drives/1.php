				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">SJEC-PLACEMENT<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Our Institute is located in Mangalore, a well known place of learning. Our college is affiliated to Visvesvaraya Technological University, Belgavi (Karnataka), recognized by AICTE, New Delhi, & by Government of Karnataka. Our credentials are well appreciated by many industries, engineering institutes, professional bodies, government organizations etc.
						</p>
					</div>
			...
			<div class="banner-bottom-grids a-banner-bottom-grids">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
						...
						<h5></span></h5>
						<p>Our Institute is located near Mangalore, a well known place of learning. Our college is affiliated to Visvesvaraya Technological University, Belgavi (Karnataka), recognized by AICTE, New Delhi, & by Government of Karnataka. Our credentials are well appreciated by many industries, engineering institutes, professional bodies, government organizations etc. 
						</p>
					</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">St Joseph College,Mangalore</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2002 SJEC | Developed by
              <a href="http://znumerique.azurewebsites.net" target="_parent"></a>
				</div>
