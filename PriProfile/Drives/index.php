		...
		<div class="testimonials">
			<div class="container">
				<div class="testimonial-nfo wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Our Motto</h3>
					<h5>SERVICE & EXCELLENCE</span>
					<p>An SJEC education provides students with the tools to realise their potential and the courage and vision to use this education in service of humanity.

Academics, Sports, Arts and opportunities for practical applications of all these contribute greatly towards holistic development of our students. Education at SJEC encourages curiosity, persistence and passion for knowledge through teaching, mentoring and caring for our students.</p>
					</h5>
				</div>
