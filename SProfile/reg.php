<?php
   ...
   mysqli_select_db($connect, "helloworld") or die("Cant Connect to database"); // Selecting Database from Server
...
{ 
 ...
 $check = mysqli_query($connect,"SELECT * FROM slogin WHERE USN='.$USN'");
