<?php
$connect = mysqli_connect("localhost", "root", "","helloworld"); // Establishing Connection with Server
...
if($cname !=''||$date !='')
{
    if($query = $connect->query("INSERT INTO `helloworld`.`addpdrive`(`CompanyName`,`Date`,`C/P`,`PVenue`,`SSLC`,`PU/Dip`,`BE`,`Backlogs`,`HofBacklogs`,`DetainYears`,`ODetails`)
